...
RouteBase get $fleetRoute => GoRouteData.$route(
  path: '/fleet',
  hasOverriddenOnExit: false,
  factory: $FleetRoute._fromState,
);

mixin $FleetRoute on GoRouteData {
  static FleetRoute _fromState(GoRouterState state) => const FleetRoute();

  @override
  String get location => GoRouteData.$location('/fleet');
...
String _$appRouterHash() => r'72979fce792d7ec66ccd32152a3e24b01d2d5447';
